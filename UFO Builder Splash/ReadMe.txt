========================================================================
    ANWENDUNG: UFO Builder Splash-Projektübersicht
========================================================================

Diese UFO Builder Splash-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre UFO Builder Splash-Anwendung besteht.

UFO Builder Splash.vcxproj
...
UFO Builder Splash.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "UFO Builder Splash.pch und eine 
